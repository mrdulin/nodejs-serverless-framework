...
var ItEbookService = /** @class */ (function () {
    function ItEbookService(resourceUrl) {
        this.resourceUrl = resourceUrl;
        if (!resourceUrl) {
            console.error('resourceUrl is required');
        }
    }
    ItEbookService.prototype.search = function (query, page) {
        return __awaiter(this, void 0, void 0, function () {
            var uri;
            return __generator(this, function (_a) {
                uri = page ? this.resourceUrl + "/search/" + query + "/page/" + page : this.resourceUrl + "/search/" + query;
    ...
    return ItEbookService;
}());
exports.ItEbookService = ItEbookService;
//# sourceMappingURL=it-ebook.service.js.map